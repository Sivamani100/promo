  ...
  const testimonials = [
    {
      ...
      content: "Found a great xerox shop near my college through Promo. The service was fast and secure!",
      rating: 5,
    ...
    },
    {
      ...
      content: "No more WhatsApp for printing! Promo makes document printing so much more secure.",
      rating: 5,
      area: "North {city}"
    }
  ];
  ...
  return (
    <section className="py-16 bg-white">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-black mb-4">
            What {city} Users Say About Promo
          </h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="text-center">
            ...
            <a href="mailto:mallipurapusiva@gmail.com" className="text-[#FB432C] font-semibold text-lg">
              mallipurapusiva@gmail.com
            </a>
          </div>
...
export function LocalFAQ({ city }: { city: string }) {
  const faqs = [
    ...
    },
    {
      ...
      answer: `Yes! You can upload documents through Promo platform and collect prints from any verified shop in ${city} within minutes.`
    },
    {
      question: `Are the xerox shops in ${city} secure and verified?`,
      answer: `All shops listed on Promo are thoroughly verified, background-checked, and follow strict security protocols to protect your documents.`
    },
    {
