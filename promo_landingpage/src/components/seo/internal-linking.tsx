  ...
  const categories = [
    ...
    },
    {
      ...
      links: [
        ...
        { href: '/about', text: 'About Promo', description: 'Learn about our mission' },
  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-12">
      <div className="text-center mb-12">
        <h2 className="text-3xl font-bold text-black mb-4">Explore Promo Services</h2>
  ...
  const relatedPosts = [
    {
      ...
      title: 'Secure Document Printing in India: Why Promo is #1',
