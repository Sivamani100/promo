  ...
  const testimonials = [
    {
      ...
      content: "Promo saved me so much time! Found a print shop near my college in 2 minutes.",
      rating: 5,
      location: "Delhi"
    },
    {
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Join thousands of students, professionals, and businesses who trust Promo for secure document printing.
          </p>
        </div>
  ...
  const comparisonData = [
    {
      ...
      Promo: "✅ Military-grade",
      whatsapp: "❌ No privacy",
      traditional: "⚠️ Basic"
    },
    {
      feature: "Document Security",
      Promo: "✅ Zero-knowledge",
  ...
  return (
    <section className="py-20 bg-gray-50">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-black mb-4">
            Promo vs Traditional Printing Methods
          </h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            See why Promo is the superior choice for secure document printing in India.
          </p>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
          <div className="grid grid-cols-4 gap-4 p-6 bg-gray-50 border-b border-gray-200">
            ...
            <div className="font-semibold text-[#FB432C] text-center">Promo</div>
          ...
          {comparisonData.map((row, index) => (
            <div key={index} className="grid grid-cols-4 gap-4 p-6 border-b border-gray-200 last:border-b-0">
              ...
              <div className="text-center text-green-600">{row.Promo}</div>
      ...
      <div className="max-w-7xl mx-auto px-6 text-center">
        <div className="max-w-3xl mx-auto space-y-8">
          ...
          <p className="text-xl text-gray-300">
            Join 50,000+ users who trust Promo for their document printing needs. 
