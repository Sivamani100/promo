...
const testimonials: Testimonial[] = [
  {
    ...
    quote: "Promo has completely stopped the WhatsApp mess in my shop. Customers just scan the QR code and print. It saves me so much time every day!"
  },
  {
    name: "Venkatesh P.",
    role: "Shop Owner, Vijayawada",
    image: "https://i.pravatar.cc/150?u=venkat",
    quote: "I've seen a 20% increase in customers since adding my shop to the Promo network. Students love the privacy and speed."
  },
  {
    name: "Prakash Rao",
  ...
  },
  {
    ...
    quote: "Promo has given my local shop a premium feel. Customers are impressed by the technology, and I get more repeat orders now."
  },
  {
    name: "Srinivas Rao",
    role: "Shop Owner, Kurnool",
    image: "https://i.pravatar.cc/150?u=srinivas",
    quote: "Managing huge volumes of student prints during exam season used to be a headache. Promo's queue system is a lifesaver for my shop."
  },
  {
    name: "Lakshmi Nara",
    role: "Shop Owner, Nellore",
    image: "https://i.pravatar.cc/150?u=lakshmi",
    quote: "As a female shop owner, I value the safety Promo provides. No more awkward WhatsApp exchanges with unknown numbers anymore."
  },
  {
    name: "Murali Krishna",
    role: "Shop Owner, Anantapur",
    image: "https://i.pravatar.cc/150?u=murali",
    quote: "With so many regular customers coming for quick document prints, Promo makes the process 10x faster and much more organized."
  },
  {
    name: "Bhavani S.",
      ...
      <div className="mx-auto w-full max-w-[1280px] px-6">
        <div className="text-center space-y-4 mb-20">
          ...
          <p className="text-lg font-medium text-gray-500 leading-relaxed italic max-w-2xl mx-auto">
            See how xerox shop owners across Andhra Pradesh are growing their business and saving time with Promo.
          </p>
        </div>
