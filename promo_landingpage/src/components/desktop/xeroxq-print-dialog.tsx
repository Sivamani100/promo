...
export default function PromoPrintDialog({ 
  documentPath, 
  base64Data, 
  onClose 
}: { 
  ...
  return (
    <div id="Promo-studio-container" className="flex h-screen w-screen fixed inset-0 z-[99999] bg-[#F8FAFC] overflow-hidden flex-col font-sans select-none text-black transition-all duration-500">
        ...
        <div className="px-6 py-4 flex items-center justify-between gap-3">
          <div className="flex items-center gap-4 shrink-0">
             ...
             <div className="flex flex-col">
                <h1 className="text-[18px] font-bold text-black leading-none tracking-tight whitespace-nowrap">Promo Studio</h1>
      ...
      {typeof document !== 'undefined' && createPortal(
         <div id="Promo-print-layer" className="hidden">
