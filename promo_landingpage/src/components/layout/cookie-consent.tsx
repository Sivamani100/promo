...
export function CookieConsent() {
  ...
  useEffect(() => {
    ...
    const consent = localStorage.getItem("Promo_cookie_consent");
    if (!consent) {
  ...
  const handleAccept = () => {
    localStorage.setItem("Promo_cookie_consent", "accepted");
    setIsVisible(false);
  };

  const handleDecline = () => {
    localStorage.setItem("Promo_cookie_consent", "declined");
    setIsVisible(false);
  };
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1 space-y-2">
                ...
                <p className="text-[12px] font-medium text-slate-400 leading-relaxed italic">
                  "Promo uses cookies to maintain your print terminal state and secure your session logic. No document contents are tracked."
                </p>
