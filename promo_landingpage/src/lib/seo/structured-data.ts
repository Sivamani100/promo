...
export function generateOrganizationSchema(): OrganizationSchema {
  return {
    ...
    logo: 'https://Promo.arkio.in/ion_print.png',
    contactPoint: {
      '@type': 'ContactPoint',
    ...
    sameAs: [
      ...
      'https://facebook.com/Promo',
      'https://linkedin.com/company/Promo',
      'https://instagram.com/Promo',
    ],
    address: {
      '@type': 'PostalAddress',
      addressCountry: 'IN',
...
export function generateWebSiteSchema(): WebSiteSchema {
  return {
    ...
    potentialAction: {
      '@type': 'SearchAction',
      target: 'https://Promo.arkio.in/search?q={search_term_string}',
...
export function generateLocalBusinessSchema(city?: string): LocalBusinessSchema {
  const baseUrl = 'https://Promo.arkio.in';
  return {
    '@context': 'https://schema.org',
    '@type': 'LocalBusiness',
    name: city ? `Promo ${city}` : 'Promo',
...
export function generateArticleSchema(article: {
  ...
  return {
    ...
    author: {
      '@type': 'Organization',
      name: article.author || 'Promo Team',
      url: baseUrl,
    },
    publisher: {
      '@type': 'Organization',
