...
export default function TermsOfUse() {
  const sections = [
    { title: "Acceptance of Terms", content: "By accessing or using the Promo platform, you agree to be bound by these Terms of Use and all applicable laws and regulations. If you do not agree with any of these terms, you are prohibited from using the platform." },
    { title: "Use License", content: "Permission is granted to brands to list campaign cards and creators to display creative portfolios and apply for matches. This is a license of software marketplace services, not a transfer of title." },
    { title: "Marketplace Disclaimer", content: "Promo facilitates connections and secure messaging. While we verify creator badges, final deliverable agreements, creative approvals, and campaign outcomes are negotiated directly between the brand and the creator." },
    { title: "Budget & Campaign Terms", content: "Listing campaign cards and creator profiles is 100% free. Any specific sponsorships or payment distributions are handled directly between the parties, and Promo holds no liability for milestone disputes." },
    { title: "Acceptable Use Policy", content: "You may not utilize the Promo platform to host illegal campaigns, copyrighted materials, or harassing content. Promo retains the right to remove any campaign card or creator profile at its sole discretion." }
  ];
          ...
          <div className="max-w-[1280px] mx-auto px-6 relative z-10 flex flex-col items-center">
             ...
             >
               ...
               <div className="flex flex-wrap items-center justify-center gap-6 md:gap-12 pt-4">
                  ...
                  <div className="flex flex-col items-center text-center">
                     <span className="text-[10px] font-black text-gray-400 uppercase tracking-widest leading-none mb-2">LEGAL COMPLIANCE</span>
                     <span className="text-[12px] font-black text-black uppercase tracking-widest bg-emerald-50 text-emerald-700 px-3 py-1 rounded-md">VERIFIED</span>
                  </div>
               </div>
             </motion.div>
          </div>
                ...
                <div className="space-y-12 pr-8">
                   ...
                   <div className="p-8 bg-[#F8FAFC] rounded-[32px] border border-gray-200">
                      ...
                      <p className="text-[13px] text-gray-500 font-medium leading-relaxed italic">
                         "Marketplace conditions are optimized for clarity and safety. We promote mutually beneficial relations."
                      </p>
                   </div>
                </div>
             </aside>
             ...
             <div className="lg:col-span-8">
                ...
                >
                   <p className="text-xl md:text-2xl text-gray-500 font-medium leading-relaxed mb-16 italic border-l-4 border-black pl-6">
                     "At Promo, we believe that clear communication is the foundation of the marketplace community. These terms govern your interaction with our dashboard and services."
                   </p>
                   ...
                   <div className="mt-24 p-10 md:p-14 bg-black rounded-[40px] relative overflow-hidden group shadow-2xl flex flex-col md:flex-row items-center gap-10 justify-between text-center md:text-left text-white">
                      ...
                      <div className="relative z-10 space-y-4 flex-1">
                         ...
                         <p className="text-base text-gray-400 font-medium italic leading-relaxed max-w-sm">"Acknowledgment of platform guidelines is requested to keep the marketplace safe."</p>
                      </div>
                      ...
                      <div className="relative z-10 shrink-0">
                         ...
                         >
                            ACCEPT TERMS <ArrowRight className="w-4 h-4" />
                         </button>
                      </div>
                   </div>
                </motion.div>
