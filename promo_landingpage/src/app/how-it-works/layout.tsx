...
export const metadata: Metadata = {
  title: "How It Works — Secure Xerox & Online Printing | Promo",
  description:
    "See exactly how Promo lets you print documents at any xerox shop near you. Upload your file, scan the QR code, print instantly. AES-256 encrypted. No data stored.",
  keywords: [
  ...
  openGraph: {
    title: "How Promo Works — Find Xerox Shops & Print Securely",
    description:
