...
export default function HowItWorksPage() {
  const customSteps = [
    { 
      ...
      description: "Brands create campaign cards detailing niche targets, social networks, location parameters, and required languages.", 
      icon: <FileCheck2 className="h-6 w-6" />,
      benefits: ["Precise targeting", "Niche category tags", "Free campaign cards"]
    },
    { 
      title: "Vetted Matches", 
      description: "Our matching engine verifies applicant profiles and follower counts, suggesting the best fit automatically.", 
      icon: <Users className="h-6 w-6" />,
      benefits: ["Verified metrics", "Automatic match fits", "One-tap approvals"]
    },
    { 
      title: "Direct Messaging", 
      description: "Connect instantly inside a secure, encrypted messaging enclave to align on deliverables and briefs.", 
      icon: <MessageSquare className="h-6 w-6" />,
      benefits: ["Zero DM spam", "Brief alignment chat", "Asset grid sharing"]
    },
    { 
      title: "Milestone Handshake", 
      description: "Manage deliverables through structured project milestones. Review drafts and complete payouts safely.", 
      icon: <Lock className="h-6 w-6" />,
      benefits: ["Escrow-like security", "Draft reviews grid", "Safe erasures"]
    }
  ];
          ...
          <div className="max-w-[1280px] mx-auto px-6 relative z-10">
            ...
            >
              <div className="inline-flex items-center gap-2.5 px-4 h-8 rounded-full bg-black/5 border border-black/5 mb-8 mx-auto">
                ...
                <span className="text-[10px] font-bold text-black uppercase tracking-[0.2em] leading-none">The Promo Protocol</span>
              </div>
              <h2 className="text-[40px] md:text-[54px] font-extrabold tracking-tighter text-black leading-[0.95] mb-6 uppercase">
                Campaign Executions <br/> In 4 Steps
              </h2>
              <p className="text-lg font-medium text-gray-500 leading-relaxed italic max-w-2xl mx-auto">
                We re-engineered how brand collaborations work from the ground up. Match with verified creators and coordinate campaigns instantly.
              </p>
            </motion.div>
              ...
              <div className="relative z-10 flex flex-col items-center gap-8">
                 ...
                 <div className="space-y-4">
                    ...
                    <p className="text-white/60 font-medium max-w-lg mx-auto leading-relaxed">
                       Create your campaign card as a brand or build your creative portfolio profile as an influencer today.
                    </p>
                 </div>
