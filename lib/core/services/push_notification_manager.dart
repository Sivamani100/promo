...
class PushNotificationManager {
  ...
  Future<void> showRationaleDialogIfNeeded(BuildContext context) async {
    ...
    final bool? allowed = await showModalBottomSheet<bool>(
      context: context,
          ...
          child: SafeArea(
            child: Column(
              ...
              children: [
                Row(
                  children: [
                    Icon(Iconsax.notification, color: AppColors.accent, size: 24),
                ...
                Text(
                  'Allow Promo to send notifications for new messages, application updates and collaboration alerts?',
